package com.springframework.sfgpetclinic.springdatajpa;
...
class OwnerSDJpaServiceTest {
    ...
    public static final String LAST_NAME = "Pathan";
    @Mock
    ...
    void findByLastName() {
        ...
        Owner pathan = service.findByLastName(LAST_NAME);

        assertEquals(LAST_NAME, pathan.getLastName());
